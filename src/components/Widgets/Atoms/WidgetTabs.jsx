...
import AppIcon from 'cozy-ui-plus/src/AppIcon'
...
export const WidgetTabs = ({
  ...
  if (!tabs || tabs.length === 0) {
    return <UnimplementedWidgetView label="No tabs available" />
  }
              ...
              >
                {state => (
                  <div
                    ...
                    className={`${styles[`app-tab`]} ${
                      styles[`app-tab--${state}`]
                    }`}
                  >
                    {content}
                  </div>
          ...
          <Button
            ...
            label={
              <Icon
                icon={tab.icon}
                color={
                  selectedTab === index ? 'var(--primaryColor)' : undefined
                }
              />
            }
...
export const UnimplementedWidgetView = ({ label = 'Unimplemented' }) => {
  return (
    <div
      style={{
        display: 'flex',
